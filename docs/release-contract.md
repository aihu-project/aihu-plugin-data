...
- Publishing uses npm trusted publishing through GitHub OIDC with provenance. A configured npm token, registry authentication error, or already-published version fails closed.
